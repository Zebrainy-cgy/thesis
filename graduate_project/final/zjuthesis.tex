...
\documentclass[
    ...
    % Thesis Info
    StudentName     = 陈冠宇,
    StudentID       = 3200102033,
    AdvisorName     = 徐翔， 倪东,
    Grade           = 2020,            % only the year, no '级'
    Major           = 数学与应用数学(强基计划),
    Department      = 数学科学学院,
    SubmitDate      = 2024年5月31号,
    MajorFormat     = general,
    ...
    % Title
    Title           = {基于对流扩散方程关于物理信息机器学习算法的研究},
    TitleEng        = {{Research about Physics-informed machine learning based on convection diffusion equation}}
]{zjuthesis}
...
\newcommand{\inputundergraduate}
{
    \ifthenelse{\equal{\Period}{final}}
    {
        ...
        \inputbody{final/2-theoretical}
        \inputbody{final/2-implement}
        \inputbody{final/2-network}
        \inputbody{final/2-numerical}
        \inputbody{final/2-forwardsum}
        ...
        % \prevstyle
        % \includepdf[pages={5-6}]{../proposal/zjuthesis.pdf} 

        % \bodystyle
        % \inputbody{proposal/review/wenxian}
        % \inputbody{proposal/proposal/kaiti}   
        % \inputbody{proposal/translation/fanyi}
